module.exports = {
	...
	'invalidUserProfileName': 'Invalid user profile name. The name must not be empty, must only contain letters and digits, has a maximum length of %%MAXLEN%% characters and must not already be used.',
	'later': 'Later',
	'line': 'Line Chart',
	'manage': 'Manage',
	'minimize': 'Minimize',
